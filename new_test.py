...
#########################################################################################################################################
swordman = Charecter(1, 1, 4, 0, "player", r"Card Game\Images\Swords man.png")
...
swordman_index = 9
#########################################################################################################################################
ion = Charecter(2, 2, 3, 1, "player", r"Card Game\Images\ion.png")
global ion_bool
ion_bool = False
global ion_battle
ion_battle = False
...
ion_index = 9
#########################################################################################################################################
apex = Charecter(3, 3, 2, 2, "player", r"Card Game\Images\Apex.png")
global apex_bool
apex_bool = False
global apex_battle
apex_battle = False
...
apex_index = 9
#########################################################################################################################################
blade = Charecter(4, 4, 2, 3, "player", r"Card Game\Images\Blade.png")
global blade_bool
blade_bool = False
global blade_battle
blade_battle = False
...
blade_index = 9
#########################################################################################################################################
tank = Charecter(4, 4, 3, 4, "player", r"Card Game\Images\tank.png")
global tank_bool
tank_bool = False
global tank_battle
tank_battle = False
...
tank_index = 9
#########################################################################################################################################
bomb = Charecter(6, 6, 1, 5, "player", r"Card Game\Images\spike bomb.png")
global bomb_bool
bomb_bool = False
global bomb_batle
bomb_batle = False
...
bomb_index = 9
#########################################################################################################################################
jolt = Charecter(5, 5, 4, 6, "player", r"Card Game\Images\New jolt.png")
global jolt_bool
jolt_bool = False
global jolt_battle
jolt_battle = False
...
#########################################################################################################################################
O_swordman = Charecter(1, 1, 4, 1, "opponent", r"Card Game\Images\Swords man.png")
global O_swordman_summon
O_swordman_summon = False
global O_swordman_index
O_swordman_index = 9
#########################################################################################################################################
O_ion = Charecter(2, 2, 3, 2, "opponent", r"Card Game\Images\ion.png")
global O_ion_summon
O_ion_summon = False
global O_ion_index
ion_index = 9
#########################################################################################################################################
O_apex = Charecter(3, 3, 2, 3, "opponent", r"Card Game\Images\Apex.png")
global O_apex_summon
O_apex_summon = False
global O_apex_index
O_apex_index = 9
#########################################################################################################################################
O_blade = Charecter(4, 4, 2, 4, "opponent", r"Card Game\Images\Blade.png")
global O_blade_summon
O_blade_summon = False
global O_blade_index
O_blade_index = 9
#########################################################################################################################################
O_tank = Charecter(4, 4, 3, 5, "opponent", r"Card Game\Images\tank.png")
global O_tank_summon
O_tank_summon = False
global O_tank_index
O_tank_index = 9
#########################################################################################################################################
O_bomb = Charecter(6, 6, 1, 6, "opponent", r"Card Game\Images\spike bomb.png")
global O_bombn_summon
O_bomb_summon = False
global O_bomb_index
O_bomb_index = 9
#########################################################################################################################################
O_jolt = Charecter(5, 5, 4, 7, "opponent", r"Card Game\Images\New jolt.png")
...
# hand
        if touch.pos[0] > Window.width/5+3*Window.width/5-3*Window.width/5/6+3*Window.width/5/72 and touch.pos[0] < Window.width/5+3*Window.width/5-3*Window.width/5/6+3*Window.width/5/72 + 3*Window.width/5/6-3*Window.width/5/36 and touch.pos[1] > 0 and touch.pos[1] < Window.height/5-Window.height/Window.height/16 and draw_per_turn >= 1:
            ...
            if player.stored[0] != "x":
                ...
                self.ids.hand_one.source = r"Card Game\Images\card_sleeve.png"
            if player.stored[1] != "x":
                self.ids.hand_two.source = player.stored[1]
            else:
                self.ids.hand_two.source = r"Card Game\Images\card_sleeve.png"
            if player.stored[2] != "x":
                self.ids.hand_three.source = player.stored[2]
            else:
                self.ids.hand_three.source = r"Card Game\Images\card_sleeve.png"
            if player.stored[3] != "x":
                self.ids.hand_four.source = player.stored[3]
            else:
                self.ids.hand_four.source = r"Card Game\Images\card_sleeve.png"
...
#########################################################################################################################################
# swordman
        if swordman_bool == True and self.ids.swordman.pos[0] >= 2*Window.width/5:
...
# hand
        ...
        if hand1 == True:
            if player.stored[0] == r"Card Game\Images\+1 attack.png":
                atk_inc = 1
            if player.stored[0] == r"Card Game\Images\+2 attack.png":
                atk_inc = 2
            if player.stored[0] == r"Card Game\Images\+3 attack.png":
                atk_inc = 3

            if player.stored[0] == r"Card Game\Images\+1 health.png":
                hp_inc = 1
            if player.stored[0] == r"Card Game\Images\+2 health.png":
                hp_inc = 2
            if player.stored[0] == r"Card Game\Images\+3 health.png":
                hp_inc = 3
            
            if player.stored[0] == r"Card Game\Images\+1 speed.png":
                spd_inc = 1
            if player.stored[0] == r"Card Game\Images\+2 speed.png":
                spd_inc = 2

            if player.stored[0] == r"Card Game\Images\-1 cooldown.png":
                for row in rest_spot:
                    if row.cd > 0:
                        row.cd -= 1
            if player.stored[0] == r"Card Game\Images\-2 cooldown.png":
                for row in rest_spot:
                    if row.cd > 0:
                        row.cd -= 1
                for row in rest_spot:
            ...
            hand1 = False
        if hand2 == True:
            if player.stored[1] == r"Card Game\Images\+1 attack.png":
                atk_inc = 1
            if player.stored[1] == r"Card Game\Images\+2 attack.png":
                atk_inc = 2
            if player.stored[1] == r"Card Game\Images\+3 attack.png":
                atk_inc = 3

            if player.stored[1] == r"Card Game\Images\+1 health.png":
                hp_inc = 1
            if player.stored[1] == r"Card Game\Images\+2 health.png":
                hp_inc = 2
            if player.stored[1] == r"Card Game\Images\+3 health.png":
                hp_inc = 3
            
            if player.stored[1] == r"Card Game\Images\+1 speed.png":
                spd_inc = 1
            if player.stored[1] == r"Card Game\Images\+2 speed.png":
                spd_inc = 2

            if player.stored[1] == r"Card Game\Images\-1 cooldown.png":
                for row in rest_spot:
                    if row.cd > 0:
                        row.cd -= 1
            if player.stored[1] == r"Card Game\Images\-2 cooldown.png":
                for row in rest_spot:
                    if row.cd > 0:
                        row.cd -= 1
                for row in rest_spot:
            ...
            hand2 = False
        if hand3 == True:
            if player.stored[2] == r"Card Game\Images\+1 attack.png":
                atk_inc = 1
            if player.stored[2] == r"Card Game\Images\+2 attack.png":
                atk_inc = 2
            if player.stored[2] == r"Card Game\Images\+3 attack.png":
                atk_inc = 3

            if player.stored[2] == r"Card Game\Images\+1 health.png":
                hp_inc = 1
            if player.stored[2] == r"Card Game\Images\+2 health.png":
                hp_inc = 2
            if player.stored[2] == r"Card Game\Images\+3 health.png":
                hp_inc = 3
            
            if player.stored[2] == r"Card Game\Images\+1 speed.png":
                spd_inc = 1
            if player.stored[2] == r"Card Game\Images\+2 speed.png":
                spd_inc = 2

            if player.stored[2] == r"Card Game\Images\-1 cooldown.png":
                for row in rest_spot:
                    if row.cd > 0:
                        row.cd -= 1
            if player.stored[2] == r"Card Game\Images\-2 cooldown.png":
                for row in rest_spot:
                    if row.cd > 0:
                        row.cd -= 1
                for row in rest_spot:
            ...
            hand3 = False
        if hand4 == True:
            if player.stored[3] == r"Card Game\Images\+1 attack.png":
                atk_inc = 1
            if player.stored[3] == r"Card Game\Images\+2 attack.png":
                atk_inc = 2
            if player.stored[3] == r"Card Game\Images\+3 attack.png":
                atk_inc = 3

            if player.stored[3] == r"Card Game\Images\+1 health.png":
                hp_inc = 1
            if player.stored[3] == r"Card Game\Images\+2 health.png":
                hp_inc = 2
            if player.stored[3] == r"Card Game\Images\+3 health.png":
                hp_inc = 3
            
            if player.stored[3] == r"Card Game\Images\+1 speed.png":
                spd_inc = 1
            if player.stored[3] == r"Card Game\Images\+2 speed.png":
                spd_inc = 2

            if player.stored[3] == r"Card Game\Images\-1 cooldown.png":
                for row in rest_spot:
                    if row.cd > 0:
                        row.cd -= 1
            if player.stored[3] == r"Card Game\Images\-2 cooldown.png":
                for row in rest_spot:
                    if row.cd > 0:
                        row.cd -= 1
                for row in rest_spot:
